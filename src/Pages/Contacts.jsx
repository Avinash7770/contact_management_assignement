...
{AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-green-500 justify-center">
...
<h1 className="text-3xl">Contact List Empty <br /> Add Contacts</h1>
</div>}

            <div className="m-4">
                <button className="rounded-full bg-green-700 p-2 text-2xl">
            ...
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-green-950 rounded-lg shadow-md m-4 p-4 text-white">
